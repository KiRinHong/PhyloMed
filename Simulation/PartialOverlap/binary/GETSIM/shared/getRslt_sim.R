...
# rm(list = ls())
# setwd("~/Project/QH0020/medtest/PhyloMed/Simulation/PartialOverlap/binary/GETSIM/shared/")
# ########## input arguments
...
outcome = rbinom(n.sample, 1, 1/(1+ exp(-(beta.t*Trt + log(M2.P[,c(S_ab, S_b)]) %*% beta))))
