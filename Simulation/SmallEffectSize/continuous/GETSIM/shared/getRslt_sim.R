# adjust A to small effect size A=0.001
# adjust B to small effect size B=0.5
...
# rm(list = ls())
# setwd("~/Project/QH0020/medtest/PhyloMed/Simulation/SmallEffectSize/continuous/GETSIM/shared/")
# ########## input arguments
